...
class CalendarActivity : AppCompatActivity() {
    ...
    private fun render() {
        ...
        val dow = GridLayout(this).apply { columnCount = 7; setPadding(0, dp(8), 0, dp(2)) }
        ...
        root.addView(dow, LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, dp(34)))

        val scroll = ScrollView(this).apply { clipToPadding = false; setPadding(0, 0, 0, dp(14)) }
        ...
        for (day in 1..month.lengthOfMonth()) {
            ...
            val textValue = buildString {
                ...
                if (info.fortnightDay.isNotBlank()) {
                    append('\n')
            ...
            val cell = TextView(this).apply {
                ...
                background = rounded(
                    if (isToday) WoWPalette.TODAY else WoWPalette.CARD,
                    dp(12).toFloat(),
                    if (isToday) WoWPalette.ACCENT else WoWPalette.LINE,
                    dp(1)
                )
            }
